...
(75,    'Medic', 'repeat', 'different look'),
(76,    'Nothing', 'repeat', 'different look'),
(77,    'Overshield', 'repeat', 'different look'),
(78,    'Nothing', 'repeat', 'different look'),
(79,    'Health Burst', 'repeat', 'different look'),
(80,    'Power Cycle', 'repeat', 'different look'),
(81,    'Leech', 'repeat', 'different look'),
(82,    'Tank', 'repeat', 'different look'),
(83,    'Everlasting', 'repeat', 'different look'),
(84,    'Enrage', 'repeat', 'different look'),
(85,    'Accelerator', 'repeat', 'different look'),
(86,    'Elemental Affinity', 'repeat', 'different look'),
(87,    'Splash Damage', 'repeat', 'different look'),
(88,    'Reload Speed', 'repeat', 'different look'),
(89,    'Lower healing, longer cooldown', 'repeat', 'different look'),
(90,    'Speed', 'repeat', 'different look'),
(91,    'Go Go Gadget', 'repeat', 'different look'),
(92,    'Hard Hitter', 'repeat', 'different look'),
(93,    'Overdose', 'repeat', 'different look'),
(94,    'Fire Rate', 'repeat', 'different look'),
(95,    'Nothing', 'repeat', 'different look'),
(96,    'Amp', 'repeat', 'different look'),
(97,    'Repkit Cooling', 'repeat', 'different look'),
